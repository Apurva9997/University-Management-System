...
public class LoginGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\apurv\\Desktop\\Netbeans\\university\\login_back.jpg")); // NOI18N
    ...
    String Password= String.valueOf(jPasswordField1.getPassword());
      ...
      String sql= "select * from users where UserName= '" + jTextField1.getText() + "' and user_Password ='" + jPasswordField1.getText() + "'";
      try
      {
